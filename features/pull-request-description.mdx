...
- If you use a PR template, you can add `{{/squire summary}}` & `{{/squire changes}}`
- If you edit a description and add `{{/squire summary}}` or `{{/squire changes}}` we will fill it after you save with the most up to date summary & changes
